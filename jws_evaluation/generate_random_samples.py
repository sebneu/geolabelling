...
if __name__ == '__main__':
    ...
    portals = ["data_gov_gr", "datos_gob_es", "www_data_gouv_fr", "data_gv_at", "offenedaten_de", "data_overheid_nl", "data_gov_ie", "opingogn_is", "data_gov_sk", "data_gov_ro", "govdata_de", "data_gov_uk"]
